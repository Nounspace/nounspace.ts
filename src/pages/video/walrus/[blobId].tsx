  ...
  return (
    <>
      <Head>
        ...
        {/* Open Graph meta tags for social media - Updated for video */}
        ...
        <meta property="og:image" content={`${baseUrl}/api/walrus/thumbnail/${blobId}`} />

        {/* Twitter Card meta tags for video */}
        ...
        <meta name="twitter:image" content={`${baseUrl}/api/walrus/thumbnail/${blobId}`} />

        {/* Farcaster Frame meta tags for direct video */}
        <meta property="fc:frame" content="vNext" />
        <meta property="fc:frame:video" content={videoUrl} />
        <meta property="fc:frame:video:type" content="video/mp4" />
        <meta property="fc:frame:image" content={`${baseUrl}/api/walrus/thumbnail/${blobId}`} />
