...
export function mentionPlugin({ scanner, parser }) {
...
// Add hashtag plugin to detect hashtags like #nouns
export const HashtagToken = createTokenClass("hashtag", { isLink: true });

export function hashtagPlugin({ scanner, parser }) {
