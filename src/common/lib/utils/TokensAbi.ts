...
export const ClankerAbiV1 = [
  {
    inputs: [
      ...
      { internalType: "string", name: "castHash_", type: "string" },
    ],
    stateMutability: "nonpayable",
    type: "constructor",
  },
...
export const MorpheusTokenAbi = [
  {
    inputs: [
      { internalType: "string", name: "name_", type: "string" },
      { internalType: "string", name: "symbol_", type: "string" },
      { internalType: "address", name: "layerZeroEndpoint_", type: "address" },
      { internalType: "address", name: "delegate_", type: "address" },
