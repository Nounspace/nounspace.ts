...
export type RGBColor = `rgb\\s*\\(\\s*${number}\\s*,\\s*${number}\\s*,\\s*${number}\\s*\\)\\s*|\\s*rgb\\s*\\(\\s*${number}%\\s*,\\s*${number}%\\s*,\\s*${number}%\\s*\\)`;
export type RGBAColor = `rgba\\s*\\(\\s*${number}\\s*,\\s*${number}\\s*,\\s*${number}\\s*,\\s*${number | `${number}%`}\\s*\\)\\s*|\\s*rgba\\s*\\(\\s*${number}%\\s*,\\s*${number}%\\s*,\\s*${number}%\\s*,\\s*${number | `${number}%`}\\s*\\)`;
export type HSLColor = `hsl\\s*\\(\\s*${number}\\s*,\\s*${number}%\\s*,\\s*${number}%\\s*\\)`;
export type HSLAColor = `hsla\\s*\\(\\s*${number}\\s*,\\s*${number}%\\s*,\\s*${number}%\\s*,\\s*${number | `${number}%`}\\s*\\)`;
