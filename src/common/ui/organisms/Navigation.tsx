...
const BrandHeader = () => {
  return (
    <Link href="/homebase" className="flex items-center ps-2.5 mb-4">
      <Image src="/images/noggles.svg" className="h-13 me-3" alt="Nounspace Logo" />
...
const Navigation = () => {
  return (
    <aside id="logo-sidebar" className="absolute top-12 bottom-12 z-8 w-[270px] transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
        ...
        <div className="text-lg font-medium">
          ...
          <div className="absolute bottom-0 left-0 right-0 px-4 py-3">
            <div className="mt-5 pt-2 border-t border-gray-200 dark:border-gray-700">
              <a href="#" className="flex items-center justify-between p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
