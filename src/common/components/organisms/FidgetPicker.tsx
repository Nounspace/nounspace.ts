      ...
      (fidgetModule: FidgetModule<FidgetArgs> | undefined, fidgetId) => {
        ...
        return (
          ...
          >
            <button
              key={fidgetId}
              className="w-20 h-24 flex flex-col items-center justify-center p-1"
            ...
            >
              <Card className="w-full h-full bg-[#F3F4F6] flex flex-col items-center justify-center p-0">
                <CardContent className="overflow-hidden flex flex-col items-start justify-center p-0 pl-2">
