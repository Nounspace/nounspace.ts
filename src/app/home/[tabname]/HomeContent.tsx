...
const HomeContent = () => {
  ...
  // Inicializa diretamente com o valor correto para evitar re-renderização
  const initialTabName = params?.tabname 
  ...
  // Sempre usar a configuração real, sem loading/initializing state
