...
export default function Space({
  ...
  const allowEditMode = editMode && (!isMobile || mobilePreview);
    ...
    <div className="w-full h-full relative flex-col">
      {showMobileContainer ? (
        <div className="flex justify-center">
          <div className="user-theme-background relative overflow-hidden w-[390px] h-[844px]">
