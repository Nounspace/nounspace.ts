...
export default function Space({
  ...
  useEffect(() => {
    ...
    // Normalize setting names with spaces
    Object.keys(cleanedFidgetInstanceDatums).forEach((id) => {
      ...
      if ("fidget Shadow" in settings) {
        settings.fidgetShadow = settings["fidget Shadow"];
        delete settings["fidget Shadow"];
        settingsChanged = true;
      }

      if ("font Color" in settings) {
        settings.fontColor = settings["font Color"];
        delete settings["font Color"];
        settingsChanged = true;
      }
    });
