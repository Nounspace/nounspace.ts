...
export const metadata = {
  ...
  APP_SUBTITLE: 'The Nounish Homepage',
  APP_DESCRIPTION: 'A social hub for all things Nouns',
  ...
  APP_TAGLINE: 'The Nounish Homepage',
  APP_OG_TITLE: 'Nouns',
  APP_OG_DESCRIPTION: 'A social hub for all things Nouns',
