...
import { Card, CardContent, CardHeader, CardTitle } from "@/common/components/atoms/card";
...
import { ProtocolConfiguration } from "../lib/protocol-config-button";
    ...
    const frameState = useFrame({
      ...
      onLaunchFrameButtonPressed(event) {
        if (event.status === "partial") {
          console.log("Partial frame loaded", "The frame is invalid, please fix errors before you decide to launch it publicly.",)
          // toast({
