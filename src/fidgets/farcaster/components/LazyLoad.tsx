...
const LazyImageComponent = ({
  ...
  const placeholder = useMemo(() => {
    ...
    return (
      <div
        className={classNames("bg-gray-200 animate-pulse rounded overflow-hidden", className)}
        style={{
          paddingBottom: `${ratio}%`,
          width: "100%",
    ...
    <div ref={ref} className="relative">
      ...
      {shouldLoad && (
        <img
          src={src}
          alt={alt}
          className={classNames(className, !loaded ? "opacity-0 absolute top-0 left-0" : "opacity-100")}
          onLoad={handleLoad}
          onError={onError}
