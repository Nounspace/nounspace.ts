...
} from "@/space/common/constants/contracts/HatsFarcasterDelegator";
import {
  encodeAbiParameters,
  encodePacked,
  hashTypedData,
...
} from "@/space/common/helpers/farcaster";
import { writeContract } from "@wagmi/core";
import { generateKeyPair } from "@/space/common/helpers/warpcastLogin";
import {
  AccountPlatformType,
  AccountStatusType,
} from "@/space/common/constants/accounts";
import { useAccountStore } from "@/space/stores/useAccountStore";
import { JoinedHerocastViaHatsProtocolDraft, useNewPostStore } from "@/space/stores/useNewPostStore";
import { useRouter } from "next/router";
import { NeynarAPIClient } from "@neynar/nodejs-sdk";
import { isValidSignature, isValidSigner } from "@/space/lib/hats";
import { SIGNED_KEY_REQUEST_TYPEHASH } from "@/space/lib/hats";
